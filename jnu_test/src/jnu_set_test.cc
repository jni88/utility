...
void SetTest::Test() {
  ...
  JNU_UT_CHECK(m1.Inject(a, a.Begin(), a.End(), m1.Begin() + 1, m1.End()));
  JNU_UT_EQUAL(m1.Size(), 4);
  JNU_UT_CHECK(m1[0].First() == "222" && m1[0].Second().m_str == "222");
  JNU_UT_CHECK(m1[1].First() == "333" && m1[1].Second().m_str == "333");
  ...
  JNU_UT_CHECK(m1.InjectSorted(m2, m2.Begin(), m2.Begin() + 2,
                               m1.Begin(), m1.End()));
  ...
  JNU_UT_CHECK(m1.Find("222")->Second().m_str == "222");
  JNU_UT_CHECK(m1.Find("333")->Second().m_str == "333");
  JNU_UT_CHECK(m1.Find("444")->Second().m_str == "444");
